...
(function () {
  ...
  var NAV_ICONS = {
    ...
    var masterDrawerHtml = [
      ...
      '<!-- 🔮 Core AI & Pantheon (Expandable) -->',
      '<details class="drawer-group">',
      '  <summary class="drawer-group-summary">',
      '    <span class="drawer-group-title"><span class="d-link-icon">' + NAV_ICONS.core + '</span> Core AI &amp; Pantheon</span>',
      '    <div class="drawer-group-right"><span class="drawer-group-chip">6 APPS</span><svg class="drawer-chevron" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></div>',
      '  </summary>',
      ...
      '<!-- 🪐 Studio Workstations (Expandable) -->',
      '<details class="drawer-group">',
      '  <summary class="drawer-group-summary">',
      '    <span class="drawer-group-title"><span class="d-link-icon">' + NAV_ICONS.cockpit + '</span> Workstations &amp; DAGs</span>',
      '    <div class="drawer-group-right"><span class="drawer-group-chip">11 TOOLS</span><svg class="drawer-chevron" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></div>',
      '  </summary>',
      '  <div class="drawer-group-body">',
      ...
      '<!-- 📜 Universe & Media (Expandable) -->',
      '<details class="drawer-group">',
      '  <summary class="drawer-group-summary">',
      '    <span class="drawer-group-title"><span class="d-link-icon">' + NAV_ICONS.comic + '</span> Universe &amp; Research</span>',
      '    <div class="drawer-group-right"><span class="drawer-group-chip">6 LABS</span><svg class="drawer-chevron" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></div>',
      '  </summary>',
      '  <div class="drawer-group-body">',
      ...
      '<!-- 📚 Docs, Security & Support (Expandable) -->',
      '<details class="drawer-group">',
      '  <summary class="drawer-group-summary">',
      '    <span class="drawer-group-title"><span class="d-link-icon">' + NAV_ICONS.docs + '</span> Docs &amp; Security</span>',
      '    <div class="drawer-group-right"><span class="drawer-group-chip">4 REPOS</span><svg class="drawer-chevron" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></div>',
      '  </summary>',
      '  <div class="drawer-group-body">',
      ...
      '<!-- 🎨 Visual Theme Grid (Expandable) -->',
      '<details class="drawer-group drawer-theme-group">',
      '  <summary class="drawer-group-summary">',
      '    <span class="drawer-group-title"><span class="d-link-icon">🎨</span> Visual Themes</span>',
      '    <div class="drawer-group-right"><span class="drawer-group-chip">' + themesList.length + ' THEMES</span><svg class="drawer-chevron" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></div>',
      '  </summary>',
      '  <div class="drawer-group-body">',
      '    <div class="drawer-search-wrap">',
      '      ' + NAV_ICONS.search + '',
      '      <input type="text" class="drawer-theme-search-input" placeholder="Search ' + themesList.length + ' themes..." autocomplete="off" />',
      '    </div>',
