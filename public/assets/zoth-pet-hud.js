  ...
  var PetHUD = {
    ...
    render: function () {
      ...
      hud.innerHTML = [
        ...
        '      <div class="pet-hud-title-wrap">',
        '        <span class="pet-hud-title">Master Narrator &amp; Companion</span>',
        '        <span class="pet-hud-subtitle">Sovereign Workstation Intelligence</span>',
        '      </div>',
        '    </div>',
        ...
        '    <div class="pet-hud-col pet-hud-col-main">',
        ...
        '        </div>',
        '        <div class="pet-hud-telemetry-row" style="margin-top: 6px;">',
        '          <span class="pet-hud-label">Harness Integration</span>',
        '          <span class="pet-hud-val" id="pet-hud-harness-val" style="font-size:0.72rem; color:var(--cyan-soft,#38bdf8);">' + pet.harness + '</span>',
        '        </div>',
        '      </div>',
        '    </div>',
        '',
        '    <div class="pet-hud-col pet-hud-col-actions">',
        '      <div class="pet-hud-field">',
        '        <label class="pet-hud-field-label">' + SVG_EYE + ' Sovereign Vision &amp; Screen Capture</label>',
        '        <button type="button" class="pet-hud-vision-btn" id="pet-hud-vision-btn">',
